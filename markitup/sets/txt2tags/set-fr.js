...
mySettings = {
	...
	markupSet: [
		...
		{name:'Table'},
		{separator:' ' },
		{name:'Image', key:'P', openWith:'[', closeWith:']', placeHolder:'http://le_nom_de_votre_image_ou_son_URL.jpg'},
		{name:'Document', openWith:'[', closeWith:']', placeHolder:'La description de votre document http://url.com/document.pdf'},
