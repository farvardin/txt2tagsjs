...
function startGui() {
	...
	markdownsyntaxPane = document.getElementById("markdownsyntaxPane");
	t2tsyntaxPane = document.getElementById("t2tsyntaxPane");
...
function onPaneSettingChanged() {
	...
	markdownsyntaxPane.style.display = "none";
	t2tsyntaxPane.style.display = "none";
...
function setPaneHeights() {
	...
	markdownsyntaxPane.style.height = roomLeft + "px";
	t2tsyntaxPane.style.height = roomLeft + "px";
}
